...
function onload(err, text) {
     ...
     function showTooltip(d, i) {
          ...
          tooltip.append('span')
            ...
            d3.select('.tooltipActive.year').attr('class', 'inactive')
     }

     //remove tooltip
     function removeTooltip() {
         d3.selectAll(".tooltipActive.year").classed("inactive", false);
     ...
     function addActive(d){
         ...
         d3.selectAll('.tooltipActive').remove();

         //show the year in the html
         var year = d3.select('.container-line-chart')
              .append('span')
              .attr('class', 'tooltipActive year')
              .text(date)

         //render tooltip
         var tooltip = d3.select('.container-line-chart')
              .append('div')
              .attr('class', "tooltipActive")
              .style('left', xPosition + "px")
              .style('top', yPosition + "px");
         tooltip.append('span')
              .text(gender)
     ...
     function renderSankey(d) {
          ...
          function onload(err, text) {
               ...
               var margin = {
                 ...
                 d3.select('.container-sankey-chart svg').remove();
               // append the svg object to the body of the page
               var svg = d3.select(".container-sankey-chart").append("svg")
